...
export class ApiService {
  ...
  teacherURL = 'https://chefitup-backend.herokuapp.com/rest/Teacher/';
  studentURL = 'https://chefitup-backend.herokuapp.com/rest/Student/';
  ingredientURL = 'https://chefitup-backend.herokuapp.com/rest/Ingredient/';
  utensilURL = 'https://chefitup-backend.herokuapp.com/rest/Utensil/';
  recipeURL = 'https://chefitup-backend.herokuapp.com/rest/Recipe/';
