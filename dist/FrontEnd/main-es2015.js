...
let DialogForCreatingClassComponent = class DialogForCreatingClassComponent {
    ...
    onNewClass(event) {
        ...
        let clase = new _models_app_models__WEBPACK_IMPORTED_MODULE_3__["Class"]();
        clase.name = name;
        ...
        this.service.addNewClass(clase).subscribe((data) => {
            console.log(data);
        });
        window.location.reload();
    }
};
DialogForCreatingClassComponent.ctorParameters = () => [
...
let GroceryDialogContentDialogComponent = class GroceryDialogContentDialogComponent {
    constructor(service) {
        this.service = service;
    ...
    ngOnInit() {
        this.ingredientSubscription = this.service.$ingredients.subscribe((ingredients) => {
            this.allIngredients = ingredients;
        });
    }
    selectedIngre(ingredient) {
...
GroceryDialogContentDialogComponent.ctorParameters = () => [
    { type: _service_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
...
let SelectItemsModalComponent = class SelectItemsModalComponent {
...
SelectItemsModalComponent.ctorParameters = () => [
...
let GroceryComponent = class GroceryComponent {
    constructor() {
        this.user = '';
        this.case = '';
    }
...
InstructorDashboardComponent.ctorParameters = () => [
    { type: _service_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
...
let InstructorNewRecipeComponent = class InstructorNewRecipeComponent {
    ...
    openGroceryDialog() {
        ...
        const dialogRef = this.dialog.open(_grocery_dialog_content_dialog_grocery_dialog_content_dialog_component__WEBPACK_IMPORTED_MODULE_4__["GroceryDialogContentDialogComponent"], {
            width: '500px',
        });
    ...
    openUtensilsDialog() {
        ...
        const dialogRef = this.dialog.open(_utensil_dialog_content_dialog_utensil_dialog_content_dialog_component__WEBPACK_IMPORTED_MODULE_5__["UtensilDialogContentDialogComponent"], { width: '500px', });
        dialogRef.afterClosed().subscribe(result => {
    ...
    createNewRecipe(event) {
        ...
        this.service.getUtensils();
        const target = event.target;
        let recipe = new _models_app_models__WEBPACK_IMPORTED_MODULE_6__["Recipe"]();
...
InstructorNewRecipeComponent.ctorParameters = () => [
    { type: _service_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
...
let InstructorComponent = class InstructorComponent {
    ...
    openDialogue() {
        const dialogRef = this.dialog.open(_dialog_for_creating_class_dialog_for_creating_class_component__WEBPACK_IMPORTED_MODULE_3__["DialogForCreatingClassComponent"], {
            width: '500px',
        });
        dialogRef.afterClosed().subscribe(result => {
            console.log('The dialog was closed');
...
let LoginComponent = class LoginComponent {
    ...
    teacherLogin(event) {
        ...
        let Data = false;
        this.service.teacherLogin(email, password).subscribe((data) => {
            if (data.name != null) {
                Data = true;
                this.teacher = data;
    ...
    studentLogin(event) {
        ...
        let Data = false;
        this.service.studentLogin(email, password).subscribe((data) => {
            console.log(data);
            if (data.name != null) {
                Data = true;
            }
...
let ApiService = class ApiService {
    ...
    setTeacher(teacher) {
        this.postTeacher(teacher).subscribe((data) => {
            console.log(data);
        });
...
let StuDashComponent = class StuDashComponent {
    constructor() { }
    ngOnInit() {
    }
    dropdownShowOrNot() {
...
let StudentDashbardComponent = class StudentDashbardComponent {
    constructor() {
...
let UtensilDialogContentDialogComponent = class UtensilDialogContentDialogComponent {
    constructor(service) {
        this.service = service;
    ...
    ngOnInit() {
        this.utensilSubscription = this.service.$utensils.subscribe((utensils) => {
            this.allUtensils = utensils;
        });
    }
    selectedUten(utensil) {
...
UtensilDialogContentDialogComponent.ctorParameters = () => [
    { type: _service_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
